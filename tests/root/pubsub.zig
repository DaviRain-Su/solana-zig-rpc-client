...
test "root.PubsubClient exposes reconnect and policy configuration through getters" {
    ...
    try std.testing.expect(pubsub.usesCustomHeartbeatInterval());
    ...
    try std.testing.expect(!pubsub.hasDefaultHeartbeatConfig());
    try std.testing.expect(pubsub.hasCustomHeartbeatConfig());
    ...
    try std.testing.expect(!pubsub.usesDefaultReconnectDelay());
    try std.testing.expect(pubsub.usesCustomReconnectDelay());
    try std.testing.expect(pubsub.isReconnectBackoffEnabled());
    try std.testing.expect(!pubsub.isReconnectFixedDelay());
    ...
    try std.testing.expect(!pubsub.usesDefaultReconnectBackoffFactor());
    try std.testing.expect(pubsub.usesCustomReconnectBackoffFactor());
    ...
    try std.testing.expect(!pubsub.hasDefaultReconnectConfig());
    try std.testing.expect(pubsub.hasCustomReconnectConfig());
    ...
    try std.testing.expect(!pubsub.hasDefaultQueueConfig());
    try std.testing.expect(pubsub.hasCustomQueueConfig());
    ...
    try std.testing.expect(!pubsub.usesDefaultHandshakeTimeout());
    try std.testing.expect(pubsub.usesCustomHandshakeTimeout());
    try std.testing.expect(pubsub.hasWriteTimeout());
    try std.testing.expect(!pubsub.usesDefaultWriteTimeout());
    try std.testing.expect(pubsub.usesCustomWriteTimeout());
    ...
    try std.testing.expect(!pubsub.usesDefaultMaxMessageSize());
    try std.testing.expect(pubsub.usesCustomMaxMessageSize());
    ...
    try std.testing.expect(!pubsub.hasDefaultTransportConfig());
    try std.testing.expect(pubsub.hasCustomTransportConfig());
    ...
    const default_options = client.PubsubClient.defaultOptions();
    try std.testing.expect(!default_options.auto_reconnect);
    try std.testing.expectEqual(@as(?u32, null), default_options.heartbeat_interval_ms);
