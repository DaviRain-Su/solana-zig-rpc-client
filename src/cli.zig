...
const cli_option_help_params = clap.parseParamsComptime(
    ...
    \\    --inspect-section <section>        Inspect output section: inspection|report|accounts|signers|summary|plan|preflight|validation|lookup-coverage|lookup-tables|diagnostics|mode-report|mode-resolution|analysis|prepared|instructions|resolved (inspect commands)
