...
pub const RpcClient = struct {
    ...
    pub const buildTransferSignedTransactionWithSender = transfer_methods.buildTransferSignedTransactionWithSender;
    pub const buildTransferSignedTransactionWithSenderAndOptions = transfer_methods.buildTransferSignedTransactionWithSenderAndOptions;
    pub const buildTransferSignedTransactionWithSenderAndConfig = transfer_methods.buildTransferSignedTransactionWithSenderAndConfig;
    pub const buildVersionedTransferSignedTransaction = transfer_methods.buildVersionedTransferSignedTransaction;
    pub const buildVersionedTransferSignedTransactionWithSender = transfer_methods.buildVersionedTransferSignedTransactionWithSender;
    pub const buildVersionedTransferSignedTransactionWithSenderAndOptions = transfer_methods.buildVersionedTransferSignedTransactionWithSenderAndOptions;
    pub const buildVersionedTransferSignedTransactionWithSenderAndConfig = transfer_methods.buildVersionedTransferSignedTransactionWithSenderAndConfig;
    ...
    pub const buildOwnedTransferMessageWithSender = transfer_methods.buildOwnedTransferMessageWithSender;
    pub const buildOwnedTransferMessageWithSenderAndOptions = transfer_methods.buildOwnedTransferMessageWithSenderAndOptions;
    pub const buildOwnedTransferMessageWithSenderAndConfig = transfer_methods.buildOwnedTransferMessageWithSenderAndConfig;
    pub const buildOwnedVersionedTransferMessageWithSender = transfer_methods.buildOwnedVersionedTransferMessageWithSender;
    pub const buildOwnedVersionedTransferMessageWithSenderAndOptions = transfer_methods.buildOwnedVersionedTransferMessageWithSenderAndOptions;
    pub const buildOwnedVersionedTransferMessageWithSenderAndConfig = transfer_methods.buildOwnedVersionedTransferMessageWithSenderAndConfig;
    pub const buildOwnedVersionedTransferMessage = transfer_methods.buildOwnedVersionedTransferMessage;
    pub const buildOwnedVersionedTransferMessageWithOptions = transfer_methods.buildOwnedVersionedTransferMessageWithOptions;
    pub const buildOwnedVersionedTransferMessageWithConfig = transfer_methods.buildOwnedVersionedTransferMessageWithConfig;
    pub const buildVersionedNonceTransferSignedTransaction = transfer_methods.buildVersionedNonceTransferSignedTransaction;
    ...
    pub const buildOwnedTransferMessage = transfer_methods.buildOwnedTransferMessage;
    ...
    pub const buildTransferMessageBytes = transfer_methods.buildTransferMessageBytes;
    ...
    pub const buildVersionedTransferMessageBytesWithSender = transfer_methods.buildVersionedTransferMessageBytesWithSender;
    pub const buildVersionedTransferMessageBytesWithSenderAndOptions = transfer_methods.buildVersionedTransferMessageBytesWithSenderAndOptions;
    pub const buildVersionedTransferMessageBytesWithSenderAndConfig = transfer_methods.buildVersionedTransferMessageBytesWithSenderAndConfig;
    pub const buildVersionedTransferMessageBase64 = transfer_methods.buildVersionedTransferMessageBase64;
    pub const buildVersionedTransferMessageBase64WithOptions = transfer_methods.buildVersionedTransferMessageBase64WithOptions;
    pub const buildVersionedTransferMessageBase64WithConfig = transfer_methods.buildVersionedTransferMessageBase64WithConfig;
    pub const buildTransferMessageBase64 = transfer_methods.buildTransferMessageBase64;
    pub const buildTransferMessageBase64WithOptions = transfer_methods.buildTransferMessageBase64WithOptions;
    pub const buildTransferMessageBase64WithConfig = transfer_methods.buildTransferMessageBase64WithConfig;
    pub const buildTransferMessageBase64WithSender = transfer_methods.buildTransferMessageBase64WithSender;
    ...
    pub const getFeeForTransferMessageResponse = transfer_methods.getFeeForTransferMessageResponse;
    pub const getFeeForTransferMessageResponseWithOptions = transfer_methods.getFeeForTransferMessageResponseWithOptions;
    pub const getFeeForTransferMessageResponseWithConfig = transfer_methods.getFeeForTransferMessageResponseWithConfig;
    pub const getFeeForTransferMessage = transfer_methods.getFeeForTransferMessage;
    pub const getFeeForTransferMessageWithOptions = transfer_methods.getFeeForTransferMessageWithOptions;
    pub const getFeeForTransferMessageWithConfig = transfer_methods.getFeeForTransferMessageWithConfig;
    pub const getFeeForTransferMessageWithSenderResponse = transfer_methods.getFeeForTransferMessageWithSenderResponse;
    pub const getFeeForTransferMessageWithSenderResponseWithOptions = transfer_methods.getFeeForTransferMessageWithSenderResponseWithOptions;
    pub const getFeeForTransferMessageWithSenderResponseWithConfig = transfer_methods.getFeeForTransferMessageWithSenderResponseWithConfig;
    pub const getFeeForTransferMessageWithSender = transfer_methods.getFeeForTransferMessageWithSender;
    ...
    pub const getFeeForVersionedTransferMessage = transfer_methods.getFeeForVersionedTransferMessage;
    pub const getFeeForVersionedTransferMessageWithOptions = transfer_methods.getFeeForVersionedTransferMessageWithOptions;
    pub const getFeeForVersionedTransferMessageWithConfig = transfer_methods.getFeeForVersionedTransferMessageWithConfig;
    pub const getFeeForVersionedTransferMessageWithSenderResponse = transfer_methods.getFeeForVersionedTransferMessageWithSenderResponse;
    pub const getFeeForVersionedTransferMessageWithSenderResponseWithOptions = transfer_methods.getFeeForVersionedTransferMessageWithSenderResponseWithOptions;
    pub const getFeeForVersionedTransferMessageWithSenderResponseWithConfig = transfer_methods.getFeeForVersionedTransferMessageWithSenderResponseWithConfig;
    pub const getFeeForVersionedTransferMessageWithSender = transfer_methods.getFeeForVersionedTransferMessageWithSender;
    ...
    pub const buildTransferTransactionWithSenderAndConfig = transfer_methods.buildTransferTransactionWithSenderAndConfig;
    pub const buildVersionedTransferTransaction = transfer_methods.buildVersionedTransferTransaction;
    pub const buildVersionedTransferTransactionWithSender = transfer_methods.buildVersionedTransferTransactionWithSender;
    pub const buildVersionedTransferTransactionWithSenderAndOptions = transfer_methods.buildVersionedTransferTransactionWithSenderAndOptions;
    pub const buildVersionedTransferTransactionWithSenderAndConfig = transfer_methods.buildVersionedTransferTransactionWithSenderAndConfig;
    ...
    pub const buildVersionedNonceTransferTransaction = transfer_methods.buildVersionedNonceTransferTransaction;
    pub const buildVersionedNonceTransferTransactionWithOptions = transfer_methods.buildVersionedNonceTransferTransactionWithOptions;
    pub const buildVersionedNonceTransferTransactionWithConfig = transfer_methods.buildVersionedNonceTransferTransactionWithConfig;
    ...
    pub const sendTransferWithSender = transfer_methods.sendTransferWithSender;
    pub const sendTransferWithSenderAndOptions = transfer_methods.sendTransferWithSenderAndOptions;
    pub const sendTransferWithSenderAndConfig = transfer_methods.sendTransferWithSenderAndConfig;
    pub const sendVersionedTransfer = transfer_methods.sendVersionedTransfer;
    pub const sendVersionedTransferWithSender = transfer_methods.sendVersionedTransferWithSender;
    pub const sendVersionedTransferWithSenderAndOptions = transfer_methods.sendVersionedTransferWithSenderAndOptions;
    pub const sendVersionedTransferWithSenderAndConfig = transfer_methods.sendVersionedTransferWithSenderAndConfig;
    ...
    pub const sendVersionedNonceTransfer = transfer_methods.sendVersionedNonceTransfer;
    pub const sendVersionedNonceTransferWithOptions = transfer_methods.sendVersionedNonceTransferWithOptions;
    pub const sendVersionedNonceTransferWithConfig = transfer_methods.sendVersionedNonceTransferWithConfig;
    ...
    pub const versionedTransferWithSender = transfer_methods.versionedTransferWithSender;
    pub const versionedTransferWithSenderAndOptions = transfer_methods.versionedTransferWithSenderAndOptions;
    pub const versionedTransferWithSenderAndConfig = transfer_methods.versionedTransferWithSenderAndConfig;
    pub const versionedTransferWithSenderAndSpinner = transfer_methods.versionedTransferWithSenderAndSpinner;
    pub const versionedTransferWithSenderAndSpinnerAndOptions = transfer_methods.versionedTransferWithSenderAndSpinnerAndOptions;
    pub const versionedTransferWithSenderAndSpinnerAndConfig = transfer_methods.versionedTransferWithSenderAndSpinnerAndConfig;
    ...
    pub const versionedNonceTransfer = transfer_methods.versionedNonceTransfer;
    pub const versionedNonceTransferWithOptions = transfer_methods.versionedNonceTransferWithOptions;
    pub const versionedNonceTransferWithConfig = transfer_methods.versionedNonceTransferWithConfig;
    pub const versionedTransferWithSpinner = transfer_methods.versionedTransferWithSpinner;
    pub const versionedTransferWithSpinnerAndOptions = transfer_methods.versionedTransferWithSpinnerAndOptions;
    pub const versionedTransferWithSpinnerAndConfig = transfer_methods.versionedTransferWithSpinnerAndConfig;
    pub const transferWithSpinner = transfer_methods.transferWithSpinner;
    pub const transferWithSpinnerAndOptions = transfer_methods.transferWithSpinnerAndOptions;
    pub const transferWithSpinnerAndConfig = transfer_methods.transferWithSpinnerAndConfig;
    pub const nonceTransferWithSpinner = transfer_methods.nonceTransferWithSpinner;
    pub const nonceTransferWithSpinnerAndOptions = transfer_methods.nonceTransferWithSpinnerAndOptions;
    pub const nonceTransferWithSpinnerAndConfig = transfer_methods.nonceTransferWithSpinnerAndConfig;
    pub const versionedNonceTransferWithSpinner = transfer_methods.versionedNonceTransferWithSpinner;
    pub const versionedNonceTransferWithSpinnerAndOptions = transfer_methods.versionedNonceTransferWithSpinnerAndOptions;
    pub const versionedNonceTransferWithSpinnerAndConfig = transfer_methods.versionedNonceTransferWithSpinnerAndConfig;
    pub const nonceTransfer = transfer_methods.nonceTransfer;
    pub const transferWithSender = transfer_methods.transferWithSender;
    pub const transferWithSenderAndOptions = transfer_methods.transferWithSenderAndOptions;
    pub const transferWithSenderAndConfig = transfer_methods.transferWithSenderAndConfig;
    pub const transferWithSenderAndSpinner = transfer_methods.transferWithSenderAndSpinner;
    pub const transferWithSenderAndSpinnerAndOptions = transfer_methods.transferWithSenderAndSpinnerAndOptions;
    pub const transferWithSenderAndSpinnerAndConfig = transfer_methods.transferWithSenderAndSpinnerAndConfig;
    ...
    pub fn newMockResponses(allocator: Allocator, responses: []const MockResponseType) !RpcClient {
        return RpcClient.newMock(allocator, responses);
    }

    pub fn newMockResponsesAndCommitment(
        allocator: Allocator,
        responses: []const MockResponseType,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newMockWithCommitment(allocator, responses, commitment);
    }

    pub fn newMockResponsesAndTimeout(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newMockWithTimeout(allocator, responses, timeout_ms);
    }

    pub fn newMockResponsesAndTimeouts(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newMockWithTimeouts(
            allocator,
            responses,
            timeout_ms,
    ...
    pub fn newMockResponsesAndCommitmentAndTimeout(
        allocator: Allocator,
        responses: []const MockResponseType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newMockWithCommitmentAndTimeout(allocator, responses, commitment, timeout_ms);
    }

    pub fn newMockResponsesAndTimeoutAndCommitment(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
        commitment: ?Commitment,
    ...
    pub fn newMockResponsesAndCommitmentAndTimeouts(
        allocator: Allocator,
        responses: []const MockResponseType,
        commitment: ?Commitment,
        timeout_ms: u64,
        ...
        return RpcClient.newMockWithCommitmentAndTimeouts(
            allocator,
            responses,
            commitment,
            timeout_ms,
    ...
    pub fn newMockResponsesAndTimeoutsAndCommitment(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ...
    pub fn newMockResponsesAndOptions(
        allocator: Allocator,
        responses: []const MockResponseType,
        options: RequestSenderOptions,
    ) !RpcClient {
    ...
    pub fn newMockResponsesAndRequestSenderOptions(
        allocator: Allocator,
        responses: []const MockResponseType,
        options: RequestSenderOptions,
    ) !RpcClient {
        return RpcClient.newMockAndRequestSenderOptions(allocator, responses, options);
    }
    ...
    pub fn newMockSender(allocator: Allocator, sender: MockSenderType) !RpcClient {
        return RpcClient.newMockWithSender(allocator, sender);
    }

    pub fn newMockSenderAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newMockWithSenderAndCommitment(allocator, sender, commitment);
    }

    pub fn newMockSenderAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newMockWithSenderAndTimeout(allocator, sender, timeout_ms);
    }

    pub fn newMockSenderAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newMockWithSenderAndTimeouts(
            allocator,
            sender,
            timeout_ms,
            confirm_transaction_initial_timeout_ms,
    ...
    pub fn newMockSenderAndCommitmentAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newMockWithSenderAndCommitmentAndTimeout(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newMockSenderAndTimeoutAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        commitment: ?Commitment,
    ...
    pub fn newMockSenderAndTimeoutsAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ...
    pub fn newMockSenderAndCommitmentAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
        ...
        return RpcClient.newMockWithSenderAndCommitmentAndTimeouts(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newMockSenderAndOptions(
        allocator: Allocator,
        sender: MockSenderType,
        options: MockClientOptions,
    ) !RpcClient {
        return RpcClient.newMockWithSenderAndOptions(allocator, sender, options);
    }

    pub fn newMockSenderAndRequestSenderOptions(
        allocator: Allocator,
        sender: MockSenderType,
        options: RequestSenderOptions,
    ) !RpcClient {
        return RpcClient.newMockWithSenderAndRequestSenderOptions(allocator, sender, options);
    }
    ...
    pub fn newMockRequestSender(
        allocator: Allocator,
        responses: []const MockResponseType,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSender(allocator, responses);
    }

    pub fn newMockRequestSenderAndOptions(
        allocator: Allocator,
        responses: []const MockResponseType,
        options: RequestSenderOptions,
    ) !RpcClient {
    ...
    pub fn newMockRequestSenderAndRequestSenderOptions(
        allocator: Allocator,
        responses: []const MockResponseType,
        options: RequestSenderOptions,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderAndRequestSenderOptions(allocator, responses, options);
    }

    pub fn newMockRequestSenderAndCommitment(
        allocator: Allocator,
        responses: []const MockResponseType,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderAndCommitment(allocator, responses, commitment);
    }

    pub fn newMockRequestSenderAndTimeout(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderAndTimeout(allocator, responses, timeout_ms);
    }

    pub fn newMockRequestSenderAndTimeouts(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderAndTimeouts(
            allocator,
            responses,
            timeout_ms,
            confirm_transaction_initial_timeout_ms,
    ...
    pub fn newMockRequestSenderAndCommitmentAndTimeout(
        allocator: Allocator,
        responses: []const MockResponseType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderAndCommitmentAndTimeout(
            allocator,
            responses,
            commitment,
            timeout_ms,
    ...
    pub fn newMockRequestSenderAndTimeoutAndCommitment(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderAndTimeoutAndCommitment(
            allocator,
            responses,
            timeout_ms,
            commitment,
    ...
    pub fn newMockRequestSenderAndCommitmentAndTimeouts(
        allocator: Allocator,
        responses: []const MockResponseType,
        commitment: ?Commitment,
        timeout_ms: u64,
        ...
        return RpcClient.newWithMockRequestSenderAndCommitmentAndTimeouts(
            allocator,
            responses,
            commitment,
            timeout_ms,
    ...
    pub fn newMockRequestSenderAndTimeoutsAndCommitment(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
        ...
        return RpcClient.newWithMockRequestSenderAndTimeoutsAndCommitment(
            allocator,
            responses,
            timeout_ms,
            confirm_transaction_initial_timeout_ms,
    ...
    pub fn newWithMockRequestSenderAndCommitment(
        ...
        return RpcClient.newWithMockRequestSenderAndOptions(
            allocator,
            responses,
            .{ .commitment = commitment },
        );
    ...
    pub fn newWithMockRequestSenderAndTimeout(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
    ) !RpcClient {
    ...
    pub fn newWithMockRequestSenderAndTimeouts(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ...
    pub fn newWithMockRequestSenderAndCommitmentAndTimeout(
        allocator: Allocator,
        responses: []const MockResponseType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ...
    pub fn newWithMockRequestSenderAndTimeoutAndCommitment(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
        commitment: ?Commitment,
    ...
    pub fn newWithMockRequestSenderAndCommitmentAndTimeouts(
        allocator: Allocator,
        responses: []const MockResponseType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ...
    pub fn newWithMockRequestSenderAndTimeoutsAndCommitment(
        allocator: Allocator,
        responses: []const MockResponseType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ...
    pub fn newMockRequestSenderWithSender(
        allocator: Allocator,
        sender: MockSenderType,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderWithSender(allocator, sender);
    }

    pub fn newMockRequestSenderWithSenderAndOptions(
        allocator: Allocator,
        sender: MockSenderType,
        options: RequestSenderOptions,
    ) !RpcClient {
    ...
    pub fn newMockRequestSenderWithSenderAndRequestSenderOptions(
        allocator: Allocator,
        sender: MockSenderType,
        options: RequestSenderOptions,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderWithSenderAndRequestSenderOptions(
            allocator,
            sender,
            options,
        );
    ...
    pub fn newMockRequestSenderWithSenderAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderWithSenderAndCommitment(allocator, sender, commitment);
    }

    pub fn newMockRequestSenderWithSenderAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderWithSenderAndTimeout(allocator, sender, timeout_ms);
    }

    pub fn newMockRequestSenderWithSenderAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderWithSenderAndTimeouts(
            allocator,
            sender,
            timeout_ms,
            confirm_transaction_initial_timeout_ms,
    ...
    pub fn newMockRequestSenderWithSenderAndCommitmentAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderWithSenderAndCommitmentAndTimeout(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newMockRequestSenderWithSenderAndTimeoutAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newWithMockRequestSenderWithSenderAndTimeoutAndCommitment(
            allocator,
            sender,
            timeout_ms,
            commitment,
    ...
    pub fn newMockRequestSenderWithSenderAndCommitmentAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
        ...
        return RpcClient.newWithMockRequestSenderWithSenderAndCommitmentAndTimeouts(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newMockRequestSenderWithSenderAndTimeoutsAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
        ...
        return RpcClient.newWithMockRequestSenderWithSenderAndTimeoutsAndCommitment(
            allocator,
            sender,
            timeout_ms,
            confirm_transaction_initial_timeout_ms,
    ...
    pub fn newMockRequestMockSender(
        allocator: Allocator,
        sender: MockSenderType,
    ) !RpcClient {
        return RpcClient.newMockRequestSenderWithSender(allocator, sender);
    }

    pub fn newMockRequestMockSenderAndOptions(
        allocator: Allocator,
        sender: MockSenderType,
        options: RequestSenderOptions,
    ) !RpcClient {
        return RpcClient.newMockRequestSenderWithSenderAndOptions(allocator, sender, options);
    }

    pub fn newMockRequestMockSenderAndRequestSenderOptions(
        allocator: Allocator,
        sender: MockSenderType,
        options: RequestSenderOptions,
    ) !RpcClient {
        return RpcClient.newMockRequestSenderWithSenderAndRequestSenderOptions(
            allocator,
            sender,
            options,
        );
    ...
    pub fn newMockRequestMockSenderAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newMockRequestSenderWithSenderAndCommitment(allocator, sender, commitment);
    }

    pub fn newMockRequestMockSenderAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newMockRequestSenderWithSenderAndTimeout(allocator, sender, timeout_ms);
    }

    pub fn newMockRequestMockSenderAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newMockRequestSenderWithSenderAndTimeouts(
            allocator,
            sender,
            timeout_ms,
            confirm_transaction_initial_timeout_ms,
    ...
    pub fn newMockRequestMockSenderAndCommitmentAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newMockRequestSenderWithSenderAndCommitmentAndTimeout(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newMockRequestMockSenderAndTimeoutAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newMockRequestSenderWithSenderAndTimeoutAndCommitment(
            allocator,
            sender,
            timeout_ms,
            commitment,
    ...
    pub fn newMockRequestMockSenderAndCommitmentAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
        ...
        return RpcClient.newMockRequestSenderWithSenderAndCommitmentAndTimeouts(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newMockRequestMockSenderAndTimeoutsAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
        ...
        return RpcClient.newMockRequestSenderWithSenderAndTimeoutsAndCommitment(
            allocator,
            sender,
            timeout_ms,
            confirm_transaction_initial_timeout_ms,
    ...
    pub fn newWithMockRequestSenderWithSenderAndCommitment(
        ...
        return RpcClient.newWithMockRequestSenderWithSenderAndOptions(
            allocator,
            sender,
            .{ .commitment = commitment },
        );
    ...
    pub fn newWithMockRequestSenderWithSenderAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
    ) !RpcClient {
    ...
    pub fn newWithMockRequestSenderWithSenderAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ...
    pub fn newWithMockRequestSenderWithSenderAndCommitmentAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ...
    pub fn newWithMockRequestSenderWithSenderAndTimeoutAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        commitment: ?Commitment,
    ...
    pub fn newWithMockRequestSenderWithSenderAndCommitmentAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ...
    pub fn newWithMockRequestSenderWithSenderAndTimeoutsAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ...
    pub fn newBorrowedMockAndCommitment(
        allocator: Allocator,
        sender: *MockSenderType,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newBorrowedMockSenderAndCommitment(allocator, sender, commitment);
    }
    ...
    pub fn newBorrowedMockSenderAndCommitment(
        ...
        return RpcClient.newWithBorrowedMockSenderAndCommitment(allocator, sender, commitment);
    }

    pub fn newBorrowedMockSenderAndTimeout(
        allocator: Allocator,
        sender: *MockSenderType,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newWithBorrowedMockSenderAndTimeout(allocator, sender, timeout_ms);
    }

    pub fn newBorrowedMockAndTimeout(
        allocator: Allocator,
        sender: *MockSenderType,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newBorrowedMockSenderAndTimeout(allocator, sender, timeout_ms);
    }

    pub fn newBorrowedMockSenderAndTimeouts(
        allocator: Allocator,
        sender: *MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ...
    pub fn newBorrowedMockAndTimeouts(
        allocator: Allocator,
        sender: *MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newBorrowedMockSenderAndTimeouts(
            allocator,
            sender,
            timeout_ms,
            confirm_transaction_initial_timeout_ms,
    ...
    pub fn newBorrowedMockSenderAndCommitmentAndTimeout(
        allocator: Allocator,
        sender: *MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newWithBorrowedMockSenderAndCommitmentAndTimeout(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newBorrowedMockAndCommitmentAndTimeout(
        allocator: Allocator,
        sender: *MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newBorrowedMockSenderAndCommitmentAndTimeout(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newBorrowedMockSenderAndTimeoutAndCommitment(
        allocator: Allocator,
        sender: *MockSenderType,
        timeout_ms: u64,
        commitment: ?Commitment,
    ...
    pub fn newBorrowedMockAndTimeoutAndCommitment(
        allocator: Allocator,
        sender: *MockSenderType,
        timeout_ms: u64,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newBorrowedMockSenderAndTimeoutAndCommitment(
            allocator,
            sender,
            timeout_ms,
            commitment,
    ...
    pub fn newBorrowedMockSenderAndCommitmentAndTimeouts(
        allocator: Allocator,
        sender: *MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
        ...
        return RpcClient.newWithBorrowedMockSenderAndCommitmentAndTimeouts(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newBorrowedMockAndCommitmentAndTimeouts(
        allocator: Allocator,
        sender: *MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
        ...
        return RpcClient.newBorrowedMockSenderAndCommitmentAndTimeouts(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newBorrowedMockSenderAndTimeoutsAndCommitment(
        allocator: Allocator,
        sender: *MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ...
    pub fn newBorrowedMockAndTimeoutsAndCommitment(
        allocator: Allocator,
        sender: *MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
        ...
        return RpcClient.newBorrowedMockSenderAndTimeoutsAndCommitment(
            allocator,
            sender,
            timeout_ms,
            confirm_transaction_initial_timeout_ms,
    ...
    pub fn newBorrowedMockSenderAndOptions(
        allocator: Allocator,
        sender: *MockSenderType,
        options: MockClientOptions,
    ) !RpcClient {
        return RpcClient.newWithBorrowedMockSenderAndOptions(allocator, sender, options);
    }

    pub fn newBorrowedMockAndOptions(
        allocator: Allocator,
        sender: *MockSenderType,
        options: MockClientOptions,
    ) !RpcClient {
        return RpcClient.newBorrowedMockSenderAndOptions(allocator, sender, options);
    }

    pub fn newBorrowedMockSenderAndRequestSenderOptions(
        allocator: Allocator,
        sender: *MockSenderType,
        options: RequestSenderOptions,
    ) !RpcClient {
    ...
    pub fn newOwnedMockAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newOwnedMockSenderAndCommitment(allocator, sender, commitment);
    }
    ...
    pub fn newOwnedMockSenderAndCommitment(
        ...
        return RpcClient.newWithOwnedMockSenderAndCommitment(allocator, sender, commitment);
    }

    pub fn newOwnedMockSenderAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newWithOwnedMockSenderAndTimeout(allocator, sender, timeout_ms);
    }

    pub fn newOwnedMockAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newOwnedMockSenderAndTimeout(allocator, sender, timeout_ms);
    }

    pub fn newOwnedMockSenderAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ...
    pub fn newOwnedMockAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newOwnedMockSenderAndTimeouts(
            allocator,
            sender,
            timeout_ms,
            confirm_transaction_initial_timeout_ms,
    ...
    pub fn newOwnedMockSenderAndCommitmentAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newWithOwnedMockSenderAndCommitmentAndTimeout(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newOwnedMockAndCommitmentAndTimeout(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
    ) !RpcClient {
        return RpcClient.newOwnedMockSenderAndCommitmentAndTimeout(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newOwnedMockSenderAndTimeoutAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        commitment: ?Commitment,
    ...
    pub fn newOwnedMockAndTimeoutAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        commitment: ?Commitment,
    ) !RpcClient {
        return RpcClient.newOwnedMockSenderAndTimeoutAndCommitment(
            allocator,
            sender,
            timeout_ms,
            commitment,
    ...
    pub fn newOwnedMockSenderAndCommitmentAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
        ...
        return RpcClient.newWithOwnedMockSenderAndCommitmentAndTimeouts(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newOwnedMockAndCommitmentAndTimeouts(
        allocator: Allocator,
        sender: MockSenderType,
        commitment: ?Commitment,
        timeout_ms: u64,
        ...
        return RpcClient.newOwnedMockSenderAndCommitmentAndTimeouts(
            allocator,
            sender,
            commitment,
            timeout_ms,
    ...
    pub fn newOwnedMockSenderAndTimeoutsAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
    ...
    pub fn newOwnedMockAndTimeoutsAndCommitment(
        allocator: Allocator,
        sender: MockSenderType,
        timeout_ms: u64,
        confirm_transaction_initial_timeout_ms: u64,
        ...
        return RpcClient.newOwnedMockSenderAndTimeoutsAndCommitment(
            allocator,
            sender,
            timeout_ms,
            confirm_transaction_initial_timeout_ms,
    ...
    pub fn newOwnedMockSenderAndOptions(
        allocator: Allocator,
        sender: MockSenderType,
        options: MockClientOptions,
    ) !RpcClient {
        return RpcClient.newWithOwnedMockSenderAndOptions(allocator, sender, options);
    }

    pub fn newOwnedMockAndOptions(
        allocator: Allocator,
        sender: MockSenderType,
        options: MockClientOptions,
    ) !RpcClient {
        return RpcClient.newOwnedMockSenderAndOptions(allocator, sender, options);
    }

    pub fn newOwnedMockSenderAndRequestSenderOptions(
        allocator: Allocator,
        sender: MockSenderType,
        options: RequestSenderOptions,
    ) !RpcClient {
    ...
    pub fn lastCapturedMockRequestId(self: *const RpcClient) ?u64 {
    ...
    pub fn lastCapturedMockRequestParamsJson(self: *const RpcClient) ?[]const u8 {
        return if (self.lastCapturedMockRequest()) |request| request.params_json else null;
    }

    pub fn lastCapturedMockRequestBody(self: *const RpcClient) ?[]const u8 {
    ...
    pub fn replaceRequestSenderAndRequestSenderOptions(
        self: *RpcClient,
        sender: RequestSenderType,
        options: RequestSenderOptions,
    ) !void {
    ...
    pub fn replaceRequestCallbackAndRequestSenderOptions(
        self: *RpcClient,
        context: ?*anyopaque,
        callback: RequestSenderType.Callback,
        options: RequestSenderOptions,
    ...
    pub fn replaceRequestCallbackAndDeinitAndRequestSenderOptions(
        self: *RpcClient,
        context: ?*anyopaque,
        callback: RequestSenderType.Callback,
        deinit_callback: RequestSenderType.DeinitCallback,
    ...
    pub fn setRequestSenderAndRequestSenderOptions(
        self: *RpcClient,
        sender: RequestSenderType,
        options: RequestSenderOptions,
    ) void {
    ...
    pub fn setRequestCallbackAndRequestSenderOptions(
        self: *RpcClient,
        context: ?*anyopaque,
        callback: RequestSenderType.Callback,
        options: RequestSenderOptions,
    ) void {
        self.setRequestSenderAndRequestSenderOptions(RequestSender.init(context, callback), options);
    }

    pub fn setRequestCallbackAndDeinitAndRequestSenderOptions(
        self: *RpcClient,
        context: ?*anyopaque,
        callback: RequestSenderType.Callback,
        deinit_callback: RequestSenderType.DeinitCallback,
    ...
    pub fn setMockRequestSender(self: *RpcClient, responses: []const MockResponseType) !void {
        self.setRequestSender(try RequestSender.initMock(self.allocator, responses));
    }

    pub fn setMockRequestResponses(self: *RpcClient, responses: []const MockResponseType) !void {
        try self.setMockRequestSender(responses);
    }

    pub fn setMockRequestSenderAndRequestSenderOptions(
        self: *RpcClient,
        responses: []const MockResponseType,
        options: RequestSenderOptions,
    ) !void {
        self.setRequestSenderAndRequestSenderOptions(
            try RequestSender.initMock(self.allocator, responses),
            options,
        );
    }

    pub fn setMockRequestResponsesAndRequestSenderOptions(
        self: *RpcClient,
        responses: []const MockResponseType,
        options: RequestSenderOptions,
    ) !void {
        try self.setMockRequestSenderAndRequestSenderOptions(responses, options);
    }

    pub fn setMockRequestSenderWithHandler(self: *RpcClient, handler: MockRequestHandlerType) !void {
        self.setRequestSender(try RequestSender.initMockWithHandler(self.allocator, handler));
    }

    pub fn setMockRequestHandler(self: *RpcClient, handler: MockRequestHandlerType) !void {
        try self.setMockRequestSenderWithHandler(handler);
    }

    pub fn setMockRequestSenderWithHandlerAndRequestSenderOptions(
        self: *RpcClient,
        handler: MockRequestHandlerType,
        options: RequestSenderOptions,
    ) !void {
    ...
    pub fn setMockRequestHandlerAndRequestSenderOptions(
        self: *RpcClient,
        handler: MockRequestHandlerType,
        options: RequestSenderOptions,
    ) !void {
        try self.setMockRequestSenderWithHandlerAndRequestSenderOptions(handler, options);
    }

    pub fn setMockRequestSenderWithSender(self: *RpcClient, sender: MockSenderType) !void {
        self.setRequestSender(try RequestSender.initMockWithSender(self.allocator, sender));
    }

    pub fn setMockRequestSenderWithSenderAndRequestSenderOptions(
        self: *RpcClient,
        sender: MockSenderType,
        options: RequestSenderOptions,
    ) !void {
    ...
    pub fn setBorrowedMock(
        self: *RpcClient,
        sender: *MockSenderType,
    ) void {
        self.setBorrowedMockSender(sender);
    }
    ...
    pub fn setBorrowedMockAndRequestSenderOptions(
        self: *RpcClient,
        sender: *MockSenderType,
        options: RequestSenderOptions,
    ) void {
        self.setBorrowedMockSenderAndRequestSenderOptions(sender, options);
    }
    ...
    pub fn setOwnedMock(self: *RpcClient, sender: MockSenderType) !void {
        try self.setOwnedMockSender(sender);
    }
    ...
    pub fn setOwnedMockAndRequestSenderOptions(
        self: *RpcClient,
        sender: MockSenderType,
        options: RequestSenderOptions,
    ) !void {
        try self.setOwnedMockSenderAndRequestSenderOptions(sender, options);
    }
    ...
    pub fn replaceBorrowedMock(
        ...
        try self.replaceWithBorrowedMockSender(sender);
    }
    ...
    pub fn replaceBorrowedMockAndRequestSenderOptions(
        self: *RpcClient,
        sender: *MockSenderType,
        options: RequestSenderOptions,
    ) !void {
        try self.replaceWithBorrowedMockSenderAndRequestSenderOptions(sender, options);
    }
    ...
    pub fn replaceOwnedMock(self: *RpcClient, sender: MockSenderType) !void {
        try self.replaceWithOwnedMockSender(sender);
    }
    ...
    pub fn replaceOwnedMockAndRequestSenderOptions(
        self: *RpcClient,
        sender: MockSenderType,
        options: RequestSenderOptions,
    ) !void {
        try self.replaceWithOwnedMockSenderAndRequestSenderOptions(sender, options);
    }

    pub fn replaceWithMockRequestSender(self: *RpcClient, responses: []const MockResponseType) !void {
        try self.replaceRequestSender(try RequestSender.initMock(self.allocator, responses));
    }

    pub fn replaceMockRequestResponses(self: *RpcClient, responses: []const MockResponseType) !void {
        try self.replaceWithMockRequestSender(responses);
    }

    pub fn replaceWithMockRequestSenderAndRequestSenderOptions(
        self: *RpcClient,
        responses: []const MockResponseType,
        options: RequestSenderOptions,
    ) !void {
    ...
    pub fn replaceMockRequestResponsesAndRequestSenderOptions(
        self: *RpcClient,
        responses: []const MockResponseType,
        options: RequestSenderOptions,
    ) !void {
        try self.replaceWithMockRequestSenderAndRequestSenderOptions(responses, options);
    }

    pub fn replaceWithMockRequestSenderWithHandler(self: *RpcClient, handler: MockRequestHandlerType) !void {
    ...
    pub fn replaceWithMockRequestSenderWithSender(self: *RpcClient, sender: MockSenderType) !void {
        try self.replaceRequestSender(try RequestSender.initMockWithSender(self.allocator, sender));
    }

    pub fn replaceWithMockRequestSenderWithSenderAndRequestSenderOptions(
        self: *RpcClient,
        sender: MockSenderType,
        options: RequestSenderOptions,
    ) !void {
    ...
    pub fn replaceWithMockAndRequestSenderOptions(
        ...
        try self.replaceWithOwnedMockSenderAndRequestSenderOptions(
            try MockSenderType.initSequence(self.allocator, responses),
            options,
        );
    }
    ...
    pub fn replaceWithMockHandlerAndRequestSenderOptions(
        self: *RpcClient,
        handler: MockRequestHandlerType,
        options: RequestSenderOptions,
    ) !void {
